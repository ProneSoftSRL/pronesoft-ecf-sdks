...
part 'model/billing_invoice_ready_payload.dart';
part 'model/branch_created_payload.dart';
part 'model/branch_status_changed_payload.dart';
part 'model/buyer.dart';
part 'model/certificate_expiring_payload.dart';
...
part 'model/contingency_activated_payload.dart';
...
part 'model/item_amount.dart';
part 'model/item_codes_inner.dart';
part 'model/item_discount_inner.dart';
part 'model/item_mining_info.dart';
part 'model/item_quantity.dart';
part 'model/item_surcharge_inner.dart';
part 'model/item_unit_price.dart';
part 'model/item_withheld_itbis_amount.dart';
part 'model/legal_status.dart';
part 'model/list_tax_sequences200_response.dart';
part 'model/member_invited_payload.dart';
part 'model/member_joined_payload.dart';
part 'model/member_removed_payload.dart';
...
part 'model/plan_payment_failed_payload.dart';
part 'model/plan_usage_alert_payload.dart';
part 'model/print_format.dart';
part 'model/processing_log.dart';
part 'model/public_document_status.dart';
...
part 'model/security_api_key_rotated_payload.dart';
part 'model/security_new_login_payload.dart';
...
part 'model/sequence_depleted_payload.dart';
part 'model/sequence_voided_payload.dart';
...
part 'model/totals_itbis_rate1.dart';
part 'model/totals_itbis_rate2.dart';
part 'model/totals_itbis_rate3.dart';
part 'model/totals_total_amount.dart';
