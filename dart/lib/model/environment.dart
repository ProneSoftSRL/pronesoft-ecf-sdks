...
class Environment {
  ...
  static const testeCF = Environment._(r'TesteCF');
  static const certeCF = Environment._(r'CerteCF');
  static const eCF = Environment._(r'eCF');
...
class EnvironmentTypeTransformer {
  ...
  Environment? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'TesteCF': return Environment.testeCF;
        case r'CerteCF': return Environment.certeCF;
        case r'eCF': return Environment.eCF;
        default:
          if (!allowNull) {
