...
class SentDocumentDetail {
  /// Returns a new [SentDocumentDetail] instance.
  SentDocumentDetail({
    this.id,
    this.encf,
    this.status,
  ...
  /// Returns a new [SentDocumentDetail] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SentDocumentDetail? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<SentDocumentDetail> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SentDocumentDetail>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SentDocumentDetail.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SentDocumentDetail> mapFromJson(dynamic json) {
    final map = <String, SentDocumentDetail>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SentDocumentDetail.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SentDocumentDetail-objects as value to a dart map
  static Map<String, List<SentDocumentDetail>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SentDocumentDetail>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SentDocumentDetail.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
