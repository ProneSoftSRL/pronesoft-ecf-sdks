  ...
  static AdditionalInfo? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return AdditionalInfo(
        ...
        grossWeightUnit: num.parse('${json[r'grossWeightUnit']}'),
        netWeightUnit: num.parse('${json[r'netWeightUnit']}'),
        packageQuantity: num.parse('${json[r'packageQuantity']}'),
        packageUnit: num.parse('${json[r'packageUnit']}'),
        packageVolume: num.parse('${json[r'packageVolume']}'),
        volumeUnit: num.parse('${json[r'volumeUnit']}'),
      );
    }
    return null;
  }
