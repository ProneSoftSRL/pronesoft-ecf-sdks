...
// checks if the ItemCodesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemCodesInner{}
...
// NewItemCodesInner instantiates a new ItemCodesInner object
...
// NewItemCodesInnerWithDefaults instantiates a new ItemCodesInner object
...
type NullableItemCodesInner struct {
	value *ItemCodesInner
	isSet bool
}

func (v NullableItemCodesInner) Get() *ItemCodesInner {
	return v.value
}

func (v *NullableItemCodesInner) Set(val *ItemCodesInner) {
	v.value = val
	v.isSet = true
}
...
func NewNullableItemCodesInner(val *ItemCodesInner) *NullableItemCodesInner {
	return &NullableItemCodesInner{value: val, isSet: true}
}
