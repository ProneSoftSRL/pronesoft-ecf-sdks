...
// checks if the EcfStatusResponseMensajesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EcfStatusResponseMensajesInner{}
...
// NewEcfStatusResponseMensajesInner instantiates a new EcfStatusResponseMensajesInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewEcfStatusResponseMensajesInner() *EcfStatusResponseMensajesInner {
	this := EcfStatusResponseMensajesInner{}
	return &this
}

// NewEcfStatusResponseMensajesInnerWithDefaults instantiates a new EcfStatusResponseMensajesInner object
...
type NullableEcfStatusResponseMensajesInner struct {
	value *EcfStatusResponseMensajesInner
	isSet bool
}

func (v NullableEcfStatusResponseMensajesInner) Get() *EcfStatusResponseMensajesInner {
	return v.value
}

func (v *NullableEcfStatusResponseMensajesInner) Set(val *EcfStatusResponseMensajesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableEcfStatusResponseMensajesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableEcfStatusResponseMensajesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEcfStatusResponseMensajesInner(val *EcfStatusResponseMensajesInner) *NullableEcfStatusResponseMensajesInner {
	return &NullableEcfStatusResponseMensajesInner{value: val, isSet: true}
}
