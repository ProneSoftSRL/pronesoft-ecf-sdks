...
`func NewDiscountOrSurcharge(lineNumber int32, type_ AdjustmentType, valueType string, amount float32, ) *DiscountOrSurcharge`
...
`func (o *DiscountOrSurcharge) GetType() AdjustmentType`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *DiscountOrSurcharge) GetTypeOk() (*AdjustmentType, bool)`
...
`func (o *DiscountOrSurcharge) SetType(v AdjustmentType)`
