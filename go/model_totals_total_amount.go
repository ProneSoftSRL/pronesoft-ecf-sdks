...
func (dst *TotalsTotalAmount) UnmarshalJSON(data []byte) error {
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(TotalsTotalAmount)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(TotalsTotalAmount)")
	}
}
...
type NullableTotalsTotalAmount struct {
	value *TotalsTotalAmount
	isSet bool
}

func (v NullableTotalsTotalAmount) Get() *TotalsTotalAmount {
	return v.value
}

func (v *NullableTotalsTotalAmount) Set(val *TotalsTotalAmount) {
	v.value = val
	v.isSet = true
}
...
func NewNullableTotalsTotalAmount(val *TotalsTotalAmount) *NullableTotalsTotalAmount {
	return &NullableTotalsTotalAmount{value: val, isSet: true}
}
