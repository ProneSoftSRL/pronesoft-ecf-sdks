...
type Item struct {
	...
	WithholdingAgentIndicator *float32 `json:"withholdingAgentIndicator,omitempty"`
	...
	UnitOfMeasure *float32 `json:"unitOfMeasure,omitempty"`
	...
	ReferenceUnit *float32 `json:"referenceUnit,omitempty"`
	...
	MiningInfo *MiningInfo `json:"miningInfo,omitempty"`
	// Decimal como string
	...
	Surcharge []SurchargeDetail `json:"surcharge,omitempty"`
...
// SetCodes gets a reference to the given []ItemCode and assigns it to the Codes field.
...
// SetWithholdingAgentIndicator gets a reference to the given float32 and assigns it to the WithholdingAgentIndicator field.
...
// SetUnitOfMeasure gets a reference to the given float32 and assigns it to the UnitOfMeasure field.
...
// SetReferenceUnit gets a reference to the given float32 and assigns it to the ReferenceUnit field.
...
// SetMiningInfo gets a reference to the given MiningInfo and assigns it to the MiningInfo field.
...
// SetDiscount gets a reference to the given []DiscountDetail and assigns it to the Discount field.
...
// SetSurcharge gets a reference to the given []SurchargeDetail and assigns it to the Surcharge field.
