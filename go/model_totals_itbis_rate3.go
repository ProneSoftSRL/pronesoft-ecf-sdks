...
func (dst *TotalsItbisRate3) UnmarshalJSON(data []byte) error {
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(TotalsItbisRate3)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(TotalsItbisRate3)")
	}
}
...
type NullableTotalsItbisRate3 struct {
	value *TotalsItbisRate3
	isSet bool
}

func (v NullableTotalsItbisRate3) Get() *TotalsItbisRate3 {
	return v.value
}

func (v *NullableTotalsItbisRate3) Set(val *TotalsItbisRate3) {
	v.value = val
	v.isSet = true
}
...
func NewNullableTotalsItbisRate3(val *TotalsItbisRate3) *NullableTotalsItbisRate3 {
	return &NullableTotalsItbisRate3{value: val, isSet: true}
}
