...
func (dst *TotalsItbisRate1) UnmarshalJSON(data []byte) error {
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(TotalsItbisRate1)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(TotalsItbisRate1)")
	}
}
...
type NullableTotalsItbisRate1 struct {
	value *TotalsItbisRate1
	isSet bool
}

func (v NullableTotalsItbisRate1) Get() *TotalsItbisRate1 {
	return v.value
}

func (v *NullableTotalsItbisRate1) Set(val *TotalsItbisRate1) {
	v.value = val
	v.isSet = true
}
...
func NewNullableTotalsItbisRate1(val *TotalsItbisRate1) *NullableTotalsItbisRate1 {
	return &NullableTotalsItbisRate1{value: val, isSet: true}
}
