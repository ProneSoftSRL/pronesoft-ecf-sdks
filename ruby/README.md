...
*PronesoftEcf::AssociatedCompaniesApi* | [**list_associated_companies**](docs/AssociatedCompaniesApi.md#list_associated_companies) | **GET** /associated-companies | List associated branches/companies
...
*PronesoftEcf::ECFSubmissionApi* | [**submit_ecf**](docs/ECFSubmissionApi.md#submit_ecf) | **POST** /{environment}/ecf/submit | Submit e-CF to platform
...
*PronesoftEcf::TaxSequencesApi* | [**get_next_number**](docs/TaxSequencesApi.md#get_next_number) | **GET** /tax-sequences/next | Get next available number
...
*PronesoftEcf::WebhookConfigurationApi* | [**list_webhooks**](docs/WebhookConfigurationApi.md#list_webhooks) | **GET** /{rnc}/webhooks | List all webhook configurations
