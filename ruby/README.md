...
*PronesoftEcf::DocumentsSentApi* | [**get_sent_document_xml**](docs/DocumentsSentApi.md#get_sent_document_xml) | **GET** /documents/sent/{id}/xml | Descargar XML del documento por ID
