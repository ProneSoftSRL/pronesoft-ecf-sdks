...
module PronesoftEcf
  class CommercialApprovalsApi
    ...
    # @param business_id [String] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ListApprovals200Response, Integer, Hash)>] ListApprovals200Response data, response status code and response headers
    def list_approvals_with_http_info(business_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ListApprovals200Response'
