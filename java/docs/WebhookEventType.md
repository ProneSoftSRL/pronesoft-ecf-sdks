...
* `DOCUMENT_RECEIVED` (value: `"document.received"`)

* `DOCUMENT_STATUS_CHANGED` (value: `"document.status_changed"`)

* `DOCUMENT_VALIDATION_ERROR` (value: `"document.validation_error"`)
...
* `SECURITY_API_KEY_ROTATED` (value: `"security.api_key_rotated"`)
