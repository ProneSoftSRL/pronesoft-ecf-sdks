...
public class ECfSubmissionApi {
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        ...
        <tr><td> 200 </td><td> Documento enviado y procesado por plataforma </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Error en la estructura de los datos (400 Bad Request) </td><td>  -  </td></tr>
     </table>
     */
    ...
    /**
     * Enviar e-CF a plataforma (Submit) (asynchronously)
     * 
     * @param xTenantId  (required)
     * @param environment  (required)
     * @param electronicDocument  (required)
