...
public class ListApprovals200Response {
  ...
  private List<CommercialApproval> data = new ArrayList<>();

  public ListApprovals200Response() {
  }

  public ListApprovals200Response data(@javax.annotation.Nullable List<CommercialApproval> data) {
    this.data = data;
    return this;
  }

  public ListApprovals200Response addDataItem(CommercialApproval dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<CommercialApproval> getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable List<CommercialApproval> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, listApprovals200Response.data);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListApprovals200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ListApprovals200Response is not found in the empty JSON string", ListApprovals200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListApprovals200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListApprovals200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            CommercialApproval.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
