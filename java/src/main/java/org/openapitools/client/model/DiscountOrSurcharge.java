...
public class DiscountOrSurcharge {
  ...
  public DiscountOrSurcharge type(@javax.annotation.Nonnull AdjustmentType type) {
    this.type = type;
    return this;
  }
  ...
  public void setType(@javax.annotation.Nonnull AdjustmentType type) {
    this.type = type;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      AdjustmentType.validateJsonElement(jsonObj.get("type"));
