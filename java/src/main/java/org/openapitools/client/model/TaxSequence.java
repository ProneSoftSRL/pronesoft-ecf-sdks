...
public class TaxSequence {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, type, startNumber, endNumber, currentNumber, availableNumbers);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "type", "startNumber", "endNumber", "currentNumber", "availableNumbers"));
