...
public class WebhookConfig {
  ...
  public WebhookConfig id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public WebhookConfig url(@javax.annotation.Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  public WebhookConfig isActive(@javax.annotation.Nullable Boolean isActive) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, webhookConfig.id) &&
        ...
        Objects.equals(this.isActive, webhookConfig.isActive);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, url, isActive);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "url", "isActive"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in WebhookConfig is not found in the empty JSON string", WebhookConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `WebhookConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
