...
public class Item {
  ...
  @javax.annotation.Nullable
  private List<ItemCode> codes = new ArrayList<>();
  ...
  @javax.annotation.Nullable
  private BigDecimal withholdingAgentIndicator;
  ...
  @javax.annotation.Nullable
  private List<DiscountDetail> discount = new ArrayList<>();
  ...
  @javax.annotation.Nullable
  private List<SurchargeDetail> surcharge = new ArrayList<>();
  ...
  public Item codes(@javax.annotation.Nullable List<ItemCode> codes) {
    this.codes = codes;
    return this;
  }

  public Item addCodesItem(ItemCode codesItem) {
    if (this.codes == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<ItemCode> getCodes() {
    return codes;
  }

  public void setCodes(@javax.annotation.Nullable List<ItemCode> codes) {
    this.codes = codes;
  }
  ...
  public Item withholdingAgentIndicator(@javax.annotation.Nullable BigDecimal withholdingAgentIndicator) {
   ...
   */
  @javax.annotation.Nullable
  public BigDecimal getWithholdingAgentIndicator() {
    return withholdingAgentIndicator;
  }

  public void setWithholdingAgentIndicator(@javax.annotation.Nullable BigDecimal withholdingAgentIndicator) {
    this.withholdingAgentIndicator = withholdingAgentIndicator;
  }
  ...
  public Item type(@javax.annotation.Nonnull ItemType type) {
    this.type = type;
    return this;
  }
  ...
  public Item unitOfMeasure(@javax.annotation.Nullable BigDecimal unitOfMeasure) {
  ...
  public void setUnitOfMeasure(@javax.annotation.Nullable BigDecimal unitOfMeasure) {
    this.unitOfMeasure = unitOfMeasure;
  }
  ...
  public Item referenceUnit(@javax.annotation.Nullable BigDecimal referenceUnit) {
  ...
  public void setReferenceUnit(@javax.annotation.Nullable BigDecimal referenceUnit) {
    this.referenceUnit = referenceUnit;
  }
  ...
  public Item miningInfo(@javax.annotation.Nullable MiningInfo miningInfo) {
  ...
  public void setMiningInfo(@javax.annotation.Nullable MiningInfo miningInfo) {
    this.miningInfo = miningInfo;
  }
  ...
  public Item discount(@javax.annotation.Nullable List<DiscountDetail> discount) {
    this.discount = discount;
    return this;
  }

  public Item addDiscountItem(DiscountDetail discountItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<DiscountDetail> getDiscount() {
    return discount;
  }

  public void setDiscount(@javax.annotation.Nullable List<DiscountDetail> discount) {
    this.discount = discount;
  }
  ...
  public Item surcharge(@javax.annotation.Nullable List<SurchargeDetail> surcharge) {
    this.surcharge = surcharge;
    return this;
  }

  public Item addSurchargeItem(SurchargeDetail surchargeItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<SurchargeDetail> getSurcharge() {
    return surcharge;
  }

  public void setSurcharge(@javax.annotation.Nullable List<SurchargeDetail> surcharge) {
    this.surcharge = surcharge;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("lineNumber", "codes", "billingIndicator", "withholdingAgentIndicator", "withheldITBISAmount", "withheldISRAmount", "name", "type", "description", "quantity", "unitOfMeasure", "referenceQuantity", "referenceUnit", "subquantities", "alcoholDegree", "referenceUnitPrice", "manufacturingDate", "expirationDate", "miningInfo", "unitPrice", "discountAmount", "discount", "surchargeAmount", "surcharge", "additionalTaxes", "alternativeCurrency", "amount"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("billingIndicator", "name", "type", "quantity", "unitPrice", "amount"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("codes") != null && !jsonObj.get("codes").isJsonNull()) {
        ...
        if (jsonArraycodes != null) {
          ...
          for (int i = 0; i < jsonArraycodes.size(); i++) {
            ItemCode.validateJsonElement(jsonArraycodes.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("miningInfo") != null && !jsonObj.get("miningInfo").isJsonNull()) {
        MiningInfo.validateJsonElement(jsonObj.get("miningInfo"));
      }
      ...
      if (jsonObj.get("discount") != null && !jsonObj.get("discount").isJsonNull()) {
        ...
        if (jsonArraydiscount != null) {
          ...
          for (int i = 0; i < jsonArraydiscount.size(); i++) {
            DiscountDetail.validateJsonElement(jsonArraydiscount.get(i));
          };
        }
      }
      if (jsonObj.get("surcharge") != null && !jsonObj.get("surcharge").isJsonNull()) {
        ...
        if (jsonArraysurcharge != null) {
          ...
          for (int i = 0; i < jsonArraysurcharge.size(); i++) {
            SurchargeDetail.validateJsonElement(jsonArraysurcharge.get(i));
          };
        }
      }
