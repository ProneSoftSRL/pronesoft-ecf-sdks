...
import org.openapitools.client.model.ItemAmount;
import org.openapitools.client.model.ItemCodesInner;
import org.openapitools.client.model.ItemDiscountInner;
import org.openapitools.client.model.ItemMiningInfo;
import org.openapitools.client.model.ItemQuantity;
import org.openapitools.client.model.ItemSurchargeInner;
import org.openapitools.client.model.ItemUnitPrice;
...
public class Item {
  ...
  @javax.annotation.Nullable
  private ItemWithheldITBISAmount withheldITBISAmount;
  ...
  @javax.annotation.Nullable
  private ItemWithheldITBISAmount withheldISRAmount;
  ...
  @javax.annotation.Nullable
  private ItemWithheldITBISAmount referenceQuantity;
  ...
  @javax.annotation.Nullable
  private ItemWithheldITBISAmount referenceUnitPrice;
  ...
  @javax.annotation.Nullable
  private ItemWithheldITBISAmount discountAmount;
  ...
  @javax.annotation.Nullable
  private ItemWithheldITBISAmount surchargeAmount;

  public static final String SERIALIZED_NAME_SURCHARGE = "surcharge";
  @SerializedName(SERIALIZED_NAME_SURCHARGE)
  @javax.annotation.Nullable
  private List<ItemSurchargeInner> surcharge = new ArrayList<>();
  ...
  public Item withheldITBISAmount(@javax.annotation.Nullable ItemWithheldITBISAmount withheldITBISAmount) {
   ...
   */
  @javax.annotation.Nullable
  public ItemWithheldITBISAmount getWithheldITBISAmount() {
    return withheldITBISAmount;
  }

  public void setWithheldITBISAmount(@javax.annotation.Nullable ItemWithheldITBISAmount withheldITBISAmount) {
    this.withheldITBISAmount = withheldITBISAmount;
  }


  public Item withheldISRAmount(@javax.annotation.Nullable ItemWithheldITBISAmount withheldISRAmount) {
   ...
   */
  @javax.annotation.Nullable
  public ItemWithheldITBISAmount getWithheldISRAmount() {
    return withheldISRAmount;
  }

  public void setWithheldISRAmount(@javax.annotation.Nullable ItemWithheldITBISAmount withheldISRAmount) {
    this.withheldISRAmount = withheldISRAmount;
  }


  public Item quantity(@javax.annotation.Nonnull ItemQuantity quantity) {
  ...
  public void setQuantity(@javax.annotation.Nonnull ItemQuantity quantity) {
    this.quantity = quantity;
  }
  ...
  public Item referenceQuantity(@javax.annotation.Nullable ItemWithheldITBISAmount referenceQuantity) {
   ...
   */
  @javax.annotation.Nullable
  public ItemWithheldITBISAmount getReferenceQuantity() {
    return referenceQuantity;
  }

  public void setReferenceQuantity(@javax.annotation.Nullable ItemWithheldITBISAmount referenceQuantity) {
    this.referenceQuantity = referenceQuantity;
  }
  ...
  public Item referenceUnitPrice(@javax.annotation.Nullable ItemWithheldITBISAmount referenceUnitPrice) {
   ...
   */
  @javax.annotation.Nullable
  public ItemWithheldITBISAmount getReferenceUnitPrice() {
    return referenceUnitPrice;
  }

  public void setReferenceUnitPrice(@javax.annotation.Nullable ItemWithheldITBISAmount referenceUnitPrice) {
    this.referenceUnitPrice = referenceUnitPrice;
  }
  ...
  public Item unitPrice(@javax.annotation.Nonnull ItemUnitPrice unitPrice) {
  ...
  public void setUnitPrice(@javax.annotation.Nonnull ItemUnitPrice unitPrice) {
    this.unitPrice = unitPrice;
  }


  public Item discountAmount(@javax.annotation.Nullable ItemWithheldITBISAmount discountAmount) {
   ...
   */
  @javax.annotation.Nullable
  public ItemWithheldITBISAmount getDiscountAmount() {
    return discountAmount;
  }

  public void setDiscountAmount(@javax.annotation.Nullable ItemWithheldITBISAmount discountAmount) {
    this.discountAmount = discountAmount;
  }
  ...
  public Item surchargeAmount(@javax.annotation.Nullable ItemWithheldITBISAmount surchargeAmount) {
   ...
   */
  @javax.annotation.Nullable
  public ItemWithheldITBISAmount getSurchargeAmount() {
    return surchargeAmount;
  }

  public void setSurchargeAmount(@javax.annotation.Nullable ItemWithheldITBISAmount surchargeAmount) {
    this.surchargeAmount = surchargeAmount;
  }


  public Item surcharge(@javax.annotation.Nullable List<ItemSurchargeInner> surcharge) {
    this.surcharge = surcharge;
    return this;
  }

  public Item addSurchargeItem(ItemSurchargeInner surchargeItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<ItemSurchargeInner> getSurcharge() {
    return surcharge;
  }

  public void setSurcharge(@javax.annotation.Nullable List<ItemSurchargeInner> surcharge) {
    this.surcharge = surcharge;
  }
  ...
  public Item amount(@javax.annotation.Nullable ItemAmount amount) {
    this.amount = amount;
    return this;
  }
  ...
  public void setAmount(@javax.annotation.Nullable ItemAmount amount) {
    this.amount = amount;
  }
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("name", "type", "billingIndicator", "quantity", "unitPrice"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `withheldITBISAmount`
      if (jsonObj.get("withheldITBISAmount") != null && !jsonObj.get("withheldITBISAmount").isJsonNull()) {
        ItemWithheldITBISAmount.validateJsonElement(jsonObj.get("withheldITBISAmount"));
      }
      // validate the optional field `withheldISRAmount`
      if (jsonObj.get("withheldISRAmount") != null && !jsonObj.get("withheldISRAmount").isJsonNull()) {
        ItemWithheldITBISAmount.validateJsonElement(jsonObj.get("withheldISRAmount"));
      }
      // validate the required field `quantity`
      ItemQuantity.validateJsonElement(jsonObj.get("quantity"));
      // validate the optional field `referenceQuantity`
      if (jsonObj.get("referenceQuantity") != null && !jsonObj.get("referenceQuantity").isJsonNull()) {
        ItemWithheldITBISAmount.validateJsonElement(jsonObj.get("referenceQuantity"));
      }
      // validate the optional field `referenceUnitPrice`
      if (jsonObj.get("referenceUnitPrice") != null && !jsonObj.get("referenceUnitPrice").isJsonNull()) {
        ItemWithheldITBISAmount.validateJsonElement(jsonObj.get("referenceUnitPrice"));
      }
      ...
      ItemUnitPrice.validateJsonElement(jsonObj.get("unitPrice"));
      // validate the optional field `discountAmount`
      if (jsonObj.get("discountAmount") != null && !jsonObj.get("discountAmount").isJsonNull()) {
        ItemWithheldITBISAmount.validateJsonElement(jsonObj.get("discountAmount"));
      }
      ...
      // validate the optional field `surchargeAmount`
      if (jsonObj.get("surchargeAmount") != null && !jsonObj.get("surchargeAmount").isJsonNull()) {
        ItemWithheldITBISAmount.validateJsonElement(jsonObj.get("surchargeAmount"));
      }
      if (jsonObj.get("surcharge") != null && !jsonObj.get("surcharge").isJsonNull()) {
        ...
        if (jsonArraysurcharge != null) {
          ...
          for (int i = 0; i < jsonArraysurcharge.size(); i++) {
            ItemSurchargeInner.validateJsonElement(jsonArraysurcharge.get(i));
          };
        }
      }
      ...
      if (jsonObj.get("amount") != null && !jsonObj.get("amount").isJsonNull()) {
        ItemAmount.validateJsonElement(jsonObj.get("amount"));
      }
  }
