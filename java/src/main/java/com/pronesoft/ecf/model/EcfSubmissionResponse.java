...
public class EcfSubmissionResponse {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(success, documentId, dgiiResponse, qrUrl, signatureTime, securityCode, encf, documentType, printUrl, isSummary, authType, timestamp, message, contingencyMode, estimatedProcessTime);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("success", "documentId", "dgiiResponse", "qrUrl", "signatureTime", "securityCode", "encf", "documentType", "printUrl", "isSummary", "authType", "timestamp", "message", "contingencyMode", "estimatedProcessTime"));
