...
public class TotalsItbisRate3 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(TotalsItbisRate3.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!TotalsItbisRate3.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'TotalsItbisRate3' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<TotalsItbisRate3>() {
                @Override
                public void write(JsonWriter out, TotalsItbisRate3 value) throws IOException {
                ...
                @Override
                public TotalsItbisRate3 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        TotalsItbisRate3 ret = new TotalsItbisRate3();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for TotalsItbisRate3: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public TotalsItbisRate3() {
        super("oneOf", Boolean.FALSE);
    }

    public TotalsItbisRate3(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return TotalsItbisRate3.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to TotalsItbisRate3
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for TotalsItbisRate3 with oneOf schemas: BigDecimal, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of TotalsItbisRate3 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of TotalsItbisRate3
     * @throws IOException if the JSON string is invalid with respect to TotalsItbisRate3
     */
    public static TotalsItbisRate3 fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, TotalsItbisRate3.class);
    }

    /**
     * Convert an instance of TotalsItbisRate3 to an JSON string
     *
     * @return JSON string
     */
