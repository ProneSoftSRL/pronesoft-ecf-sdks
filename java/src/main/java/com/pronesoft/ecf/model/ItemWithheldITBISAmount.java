...
public class ItemWithheldITBISAmount extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ItemWithheldITBISAmount.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ItemWithheldITBISAmount.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ItemWithheldITBISAmount' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ItemWithheldITBISAmount>() {
                @Override
                public void write(JsonWriter out, ItemWithheldITBISAmount value) throws IOException {
                ...
                @Override
                public ItemWithheldITBISAmount read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ItemWithheldITBISAmount ret = new ItemWithheldITBISAmount();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for ItemWithheldITBISAmount: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ItemWithheldITBISAmount() {
        super("oneOf", Boolean.FALSE);
    }

    public ItemWithheldITBISAmount(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return ItemWithheldITBISAmount.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to ItemWithheldITBISAmount
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for ItemWithheldITBISAmount with oneOf schemas: BigDecimal, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of ItemWithheldITBISAmount given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of ItemWithheldITBISAmount
     * @throws IOException if the JSON string is invalid with respect to ItemWithheldITBISAmount
     */
    public static ItemWithheldITBISAmount fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, ItemWithheldITBISAmount.class);
    }

    /**
     * Convert an instance of ItemWithheldITBISAmount to an JSON string
     *
     * @return JSON string
     */
