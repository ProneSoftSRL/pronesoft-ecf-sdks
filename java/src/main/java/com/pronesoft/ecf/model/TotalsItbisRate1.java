...
public class TotalsItbisRate1 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(TotalsItbisRate1.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!TotalsItbisRate1.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'TotalsItbisRate1' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<TotalsItbisRate1>() {
                @Override
                public void write(JsonWriter out, TotalsItbisRate1 value) throws IOException {
                ...
                @Override
                public TotalsItbisRate1 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        TotalsItbisRate1 ret = new TotalsItbisRate1();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for TotalsItbisRate1: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public TotalsItbisRate1() {
        super("oneOf", Boolean.FALSE);
    }

    public TotalsItbisRate1(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return TotalsItbisRate1.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to TotalsItbisRate1
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for TotalsItbisRate1 with oneOf schemas: BigDecimal, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of TotalsItbisRate1 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of TotalsItbisRate1
     * @throws IOException if the JSON string is invalid with respect to TotalsItbisRate1
     */
    public static TotalsItbisRate1 fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, TotalsItbisRate1.class);
    }

    /**
     * Convert an instance of TotalsItbisRate1 to an JSON string
     *
     * @return JSON string
     */
