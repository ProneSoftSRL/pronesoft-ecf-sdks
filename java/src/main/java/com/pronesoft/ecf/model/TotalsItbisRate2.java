...
public class TotalsItbisRate2 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(TotalsItbisRate2.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!TotalsItbisRate2.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'TotalsItbisRate2' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<TotalsItbisRate2>() {
                @Override
                public void write(JsonWriter out, TotalsItbisRate2 value) throws IOException {
                ...
                @Override
                public TotalsItbisRate2 read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        TotalsItbisRate2 ret = new TotalsItbisRate2();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for TotalsItbisRate2: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public TotalsItbisRate2() {
        super("oneOf", Boolean.FALSE);
    }

    public TotalsItbisRate2(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return TotalsItbisRate2.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to TotalsItbisRate2
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for TotalsItbisRate2 with oneOf schemas: BigDecimal, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of TotalsItbisRate2 given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of TotalsItbisRate2
     * @throws IOException if the JSON string is invalid with respect to TotalsItbisRate2
     */
    public static TotalsItbisRate2 fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, TotalsItbisRate2.class);
    }

    /**
     * Convert an instance of TotalsItbisRate2 to an JSON string
     *
     * @return JSON string
     */
