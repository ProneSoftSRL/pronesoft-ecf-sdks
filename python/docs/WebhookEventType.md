...
* `DOCUMENT_DOT_RECEIVED` (value: `'document.received'`)

* `DOCUMENT_DOT_STATUS_CHANGED` (value: `'document.status_changed'`)

* `DOCUMENT_DOT_VALIDATION_ERROR` (value: `'document.validation_error'`)
