...
with pronesoft_ecf.ApiClient(configuration) as api_client:
    ...
    o_auth_token_request = {"clientId":"app_live_TU_CLIENT_ID","clientSecret":"sk_live_TU_CLIENT_SECRET"} # OAuthTokenRequest | 
