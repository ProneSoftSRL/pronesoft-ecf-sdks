...
class WebhookNotificationPayload(BaseModel):
    ...
    """ # noqa: E501
    id: UUID = Field(description="Unique notification identifier (use for deduplication).")
    event: WebhookEventType
    timestamp: datetime = Field(description="When the event occurred (ISO 8601).")
    business_rnc: StrictStr = Field(description="RNC of the company that triggered the event.", alias="businessRnc")
