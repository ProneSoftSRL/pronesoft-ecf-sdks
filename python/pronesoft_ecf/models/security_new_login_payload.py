...
class SecurityNewLoginPayload(BaseModel):
    """
    ...
    city: Optional[StrictStr] = Field(default=None, description="Ciudad detectada por geolocalización.")
    __properties: ClassVar[List[str]] = ["ip", "userAgent", "city"]
