...
class BranchStatusChangedPayload(BaseModel):
    """
    Payload del evento `branch.status_changed`. Una empresa asociada cambió de estado.
    """ # noqa: E501
    branch_id: StrictStr = Field(alias="branchId")
    new_status: StrictStr = Field(description="Nuevo estado de la sucursal.", alias="newStatus")
    __properties: ClassVar[List[str]] = ["branchId", "newStatus"]
