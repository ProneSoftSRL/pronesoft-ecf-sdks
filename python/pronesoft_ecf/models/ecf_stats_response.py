...
class EcfStatsResponse(BaseModel):
    """
    EcfStatsResponse
    """ # noqa: E501
    total: Optional[StrictInt] = None
    accepted: Optional[StrictInt] = None
    rejected: Optional[StrictInt] = None
    ...
    __properties: ClassVar[List[str]] = ["total", "accepted", "rejected", "processing", "error", "successRate", "period", "dateFrom", "dateTo"]
