...
class SentDocumentDetail(BaseModel):
    ...
    status_display: Optional[StrictStr] = Field(default=None, alias="statusDisplay")
    ...
    xml_url: Optional[StrictStr] = Field(default=None, alias="xmlUrl")
    business: Optional[SentDocumentSummaryBusiness] = None
    logs: Optional[List[ProcessingLog]] = None
    audit_logs: Optional[List[Dict[str, Any]]] = Field(default=None, alias="auditLogs")
    __properties: ClassVar[List[str]] = ["id", "encf", "status", "statusDisplay", "trackId", "documentType", "totalAmount", "receivedAt", "createdAt", "xmlUrl", "business", "logs", "auditLogs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "statusDisplay": obj.get("statusDisplay"),
