...
class BillingInvoiceReadyPayload(BaseModel):
    """
    ...
    pdf_url: StrictStr = Field(description="URL de descarga del PDF de la factura.", alias="pdfUrl")
    __properties: ClassVar[List[str]] = ["invoiceId", "amount", "pdfUrl"]
