...
class AlternativeCurrency(BaseModel):
    ...
    additional_taxes: Optional[List[StrictStr]] = Field(default=None, alias="additionalTaxes")
    ...
    __properties: ClassVar[List[str]] = ["code", "exchangeRate", "taxableAmount", "taxableAmount1", "taxableAmount2", "taxableAmount3", "exemptAmount", "totalITBIS", "itbis1", "itbis2", "itbis3", "additionalTaxAmount", "additionalTaxes", "nonBillableAmount", "totalAmount"]
