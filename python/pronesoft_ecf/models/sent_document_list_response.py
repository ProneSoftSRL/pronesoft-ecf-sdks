...
class SentDocumentListResponse(BaseModel):
    """
    SentDocumentListResponse
    """ # noqa: E501
    data: Optional[List[SentDocumentSummary]] = None
    meta: Optional[PaginationMeta] = None
    filters: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["data", "meta", "filters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [SentDocumentSummary.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
