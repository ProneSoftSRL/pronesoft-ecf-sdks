...
class GetEcfSubmissionHistory200Response(BaseModel):
    """
    GetEcfSubmissionHistory200Response
    """ # noqa: E501
    data: Optional[List[EcfHistoryItem]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [EcfHistoryItem.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
