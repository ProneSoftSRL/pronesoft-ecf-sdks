...
class OAuthTokenRequest(BaseModel):
    ...
    """ # noqa: E501
    client_id: StrictStr = Field(description="Your application's client ID from the Pronesoft portal.", alias="clientId")
    client_secret: StrictStr = Field(description="Your application's client secret. Keep this confidential.", alias="clientSecret")
