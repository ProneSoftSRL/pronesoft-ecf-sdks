...
class WebhookConfigDetail(BaseModel):
    """
    WebhookConfigDetail
    """ # noqa: E501
    ...
    deliveries: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["id", "url", "description", "eventTypes", "isActive", "createdAt", "updatedAt", "lastTriggeredAt", "deliveries"]
