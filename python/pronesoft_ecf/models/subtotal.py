...
class Subtotal(BaseModel):
    ...
    """ # noqa: E501
    number: StrictInt = Field(description="Page or section number.")
    amount: Union[StrictFloat, StrictInt] = Field(description="Subtotal amount for this section.")
    ...
    lines: Optional[StrictInt] = Field(default=None, description="Number of line items included in this subtotal.")
