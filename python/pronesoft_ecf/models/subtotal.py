...
class Subtotal(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["number", "description", "order", "taxableAmount", "taxableAmount1", "taxableAmount2", "taxableAmount3", "totalITBIS", "itbis1", "itbis2", "itbis3", "additionalTaxes", "exemptAmount", "amount", "lines"]
