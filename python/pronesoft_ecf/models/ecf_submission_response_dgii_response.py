...
class EcfSubmissionResponseDgiiResponse(BaseModel):
    """
    EcfSubmissionResponseDgiiResponse
    """ # noqa: E501
    track_id: Optional[StrictStr] = Field(default=None, alias="trackId")
    estado: Optional[StrictStr] = Field(default=None, description="Aprobado, Rechazado, En Proceso")
    rnc: Optional[StrictStr] = None
    encf: Optional[StrictStr] = None
    fecha_recepcion: Optional[datetime] = Field(default=None, alias="fechaRecepcion")
