...
class SecurityApiKeyRotatedPayload(BaseModel):
    """
    Payload del evento `security.api_key_rotated`. Una App rotó su clientSecret.
    """ # noqa: E501
    app_id: StrictStr = Field(description="ID de la aplicación cuya clave fue rotada.", alias="appId")
    rotated_at: datetime = Field(alias="rotatedAt")
    __properties: ClassVar[List[str]] = ["appId", "rotatedAt"]
