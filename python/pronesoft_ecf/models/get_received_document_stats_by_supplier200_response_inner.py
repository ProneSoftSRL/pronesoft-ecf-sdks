...
class GetReceivedDocumentStatsBySupplier200ResponseInner(BaseModel):
    """
    GetReceivedDocumentStatsBySupplier200ResponseInner
    """ # noqa: E501
    supplier_rnc: Optional[StrictStr] = Field(default=None, alias="supplierRnc")
    count: Optional[StrictInt] = None
    total_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="totalAmount")
    __properties: ClassVar[List[str]] = ["supplierRnc", "count", "totalAmount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "supplierRnc": obj.get("supplierRnc"),
            "count": obj.get("count"),
