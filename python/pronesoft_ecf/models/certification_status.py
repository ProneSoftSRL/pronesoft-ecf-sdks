...
class CertificationStatus(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["status", "createdAt", "errorLog"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if error_log (nullable) is None
        # and model_fields_set contains the field
        if self.error_log is None and "error_log" in self.model_fields_set:
            _dict['errorLog'] = None
