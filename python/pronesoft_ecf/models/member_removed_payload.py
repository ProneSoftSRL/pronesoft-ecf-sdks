...
class MemberRemovedPayload(BaseModel):
    ...
    email: StrictStr
    removed_by: StrictStr = Field(description="Email del usuario que realizó la remoción.", alias="removedBy")
    __properties: ClassVar[List[str]] = ["userId", "email", "removedBy"]
