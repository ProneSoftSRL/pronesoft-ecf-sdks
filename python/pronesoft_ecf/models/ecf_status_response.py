...
class EcfStatusResponse(BaseModel):
    ...
    mensajes: Optional[List[EcfStatusResponseMensajesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mensajes": [EcfStatusResponseMensajesInner.from_dict(_item) for _item in obj["mensajes"]] if obj.get("mensajes") is not None else None,
