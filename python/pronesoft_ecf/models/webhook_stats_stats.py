...
class WebhookStatsStats(BaseModel):
    """
    WebhookStatsStats
    """ # noqa: E501
    total_attempts: Optional[StrictInt] = Field(default=None, alias="totalAttempts")
    successful: Optional[StrictInt] = None
    failed: Optional[StrictInt] = None
    success_rate: Optional[StrictStr] = Field(default=None, alias="successRate")
    average_response_time: Optional[StrictInt] = Field(default=None, alias="averageResponseTime")
    last_attempt: Optional[datetime] = Field(default=None, alias="lastAttempt")
    __properties: ClassVar[List[str]] = ["totalAttempts", "successful", "failed", "successRate", "averageResponseTime", "lastAttempt"]
