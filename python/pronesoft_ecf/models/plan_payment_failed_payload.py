...
class PlanPaymentFailedPayload(BaseModel):
    """
    ...
    amount: Union[StrictFloat, StrictInt] = Field(description="Monto del pago fallido.")
    reason: StrictStr = Field(description="Razón del fallo.")
    __properties: ClassVar[List[str]] = ["invoiceId", "amount", "reason"]
