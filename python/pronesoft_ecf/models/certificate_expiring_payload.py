...
class CertificateExpiringPayload(BaseModel):
    """
    ...
    days_left: StrictInt = Field(description="Días restantes hasta el vencimiento.", alias="daysLeft")
    __properties: ClassVar[List[str]] = ["expirationDate", "daysLeft"]
