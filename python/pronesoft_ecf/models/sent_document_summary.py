...
class SentDocumentSummary(BaseModel):
    """
    SentDocumentSummary
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "encf", "status", "statusLabel", "trackId", "documentType", "issuerRnc", "environment", "receivedAt", "createdAt", "business"]
