...
class DigitalCertificatesApi:
    ...
    def upload_certificate(
        ...
        file: Annotated[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]], Field(description="The P12/PFX certificate file.")],
        password: Annotated[StrictStr, Field(description="Password to unlock the P12 certificate.")],
        ...
        :type rnc: str
        :param file: The P12/PFX certificate file. (required)
        :type file: bytes
