...
class DocumentsSentApi:
    ...
    @validate_call
    def get_sent_document_xml(
        self,
        id: Annotated[UUID, Field(description="ID interno del documento")],
        inline: Annotated[Optional[StrictStr], Field(description="true para ver en el navegador, false para descargar")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._get_sent_document_xml_serialize(
            id=id,
            inline=inline,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_sent_document_xml_with_http_info(
        self,
        id: Annotated[UUID, Field(description="ID interno del documento")],
        inline: Annotated[Optional[StrictStr], Field(description="true para ver en el navegador, false para descargar")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_sent_document_xml_without_preload_content(
        self,
        id: Annotated[UUID, Field(description="ID interno del documento")],
        inline: Annotated[Optional[StrictStr], Field(description="true para ver en el navegador, false para descargar")] = None,
        _request_timeout: Union[
    ...
    def _get_sent_document_xml_serialize(
        self,
        id,
        inline,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/documents/sent/{id}/xml',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
