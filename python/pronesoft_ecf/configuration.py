...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        ...
        "tenantIdHeader": APIKeyAuthSetting,
    },
    total=False,
)
...
conf = pronesoft_ecf.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://api.ecf.sandbox.pronesoft.com/api/v1" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("pronesoft_ecf")
    ...
    def auth_settings(self)-> AuthSettings:
        ...
        if 'tenantIdHeader' in self.api_key:
            auth['tenantIdHeader'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'x-tenant-id',
