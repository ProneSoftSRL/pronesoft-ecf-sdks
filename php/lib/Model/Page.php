 ...
 *
 * @category Class
 * @description Page-level breakdown for multi-page documents.
 * @package  PronesoftEcf
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Page implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets line_from
     *
     * @param int $line_from First line item number on this page.
     *
     * @return self
     */
     ...
     * Sets line_to
     *
     * @param int $line_to Last line item number on this page.
     *
     * @return self
     */
