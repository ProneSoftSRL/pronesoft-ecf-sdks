 ...
 *
 * @category Class
 * @description Successful token response. Use &#x60;accessToken&#x60; as a Bearer token in the &#x60;Authorization&#x60; header of all subsequent requests.
 * @package  PronesoftEcf
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class OAuthTokenResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets access_token
     *
     * @param string|null $access_token JWT Bearer token. Pass as Authorization: Bearer <accessToken>.
     *
     * @return self
     */
     ...
     * Sets expires_in
     *
     * @param int|null $expires_in Token lifetime in seconds. Request a new token when it expires.
     *
     * @return self
     */
