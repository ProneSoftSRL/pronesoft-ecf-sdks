...
class ItemAdditionalTax implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'code' => 'string',
        'amount' => '\PronesoftEcf\Model\ItemWithheldITBISAmount',
        'rate' => 'float',
     ...
     * Sets code
     *
     * @param string $code DGII tax code (e.g. ISC, IECS)
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param \PronesoftEcf\Model\ItemWithheldITBISAmount|null $amount amount
     *
     * @return self
     */
