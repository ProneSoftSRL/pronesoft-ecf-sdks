 ...
 *
 * @category Class
 * @description Response returned after successfully submitting an e-CF document.
 * @package  PronesoftEcf
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class EcfSubmissionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets success
     *
     * @param bool $success Whether the document was accepted by the platform.
     *
     * @return self
     */
     ...
     * Sets document_id
     *
     * @param string $document_id Pronesoft internal document identifier.
     *
     * @return self
     */
     ...
     * Sets encf
     *
     * @param string|null $encf The e-NCF number assigned to the document.
     *
     * @return self
     */
     ...
     * Sets track_id
     *
     * @param string|null $track_id DGII tracking ID for status polling.
     *
     * @return self
     */
