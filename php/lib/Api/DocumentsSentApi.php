...
class DocumentsSentApi
{
    ...
    /**
     * Operation getSentDocumentXml
     *
     * Descargar XML del documento por ID
     *
     * @param  string $id ID interno del documento (required)
     * @param  string|null $inline true para ver en el navegador, false para descargar (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSentDocumentXml'] to see the possible values for this operation
     *
     * @throws \PronesoftEcf\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return string|\PronesoftEcf\Model\ErrorResponse
     */
    public function getSentDocumentXml($id, $inline = null, string $contentType = self::contentTypes['getSentDocumentXml'][0])
    {
        list($response) = $this->getSentDocumentXmlWithHttpInfo($id, $inline, $contentType);
        return $response;
    }

    /**
     * Operation getSentDocumentXmlWithHttpInfo
     *
     * Descargar XML del documento por ID
     *
     * @param  string $id ID interno del documento (required)
     ...
     * @return array of string|\PronesoftEcf\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSentDocumentXmlWithHttpInfo($id, $inline = null, string $contentType = self::contentTypes['getSentDocumentXml'][0])
    {
        $request = $this->getSentDocumentXmlRequest($id, $inline, $contentType);
    ...
    /**
     * Operation getSentDocumentXmlAsync
     *
     * Descargar XML del documento por ID
     *
     * @param  string $id ID interno del documento (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSentDocumentXmlAsync($id, $inline = null, string $contentType = self::contentTypes['getSentDocumentXml'][0])
    {
        return $this->getSentDocumentXmlAsyncWithHttpInfo($id, $inline, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSentDocumentXmlAsyncWithHttpInfo
     *
     * Descargar XML del documento por ID
     *
     * @param  string $id ID interno del documento (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSentDocumentXmlAsyncWithHttpInfo($id, $inline = null, string $contentType = self::contentTypes['getSentDocumentXml'][0])
    {
        $returnType = 'string';
        $request = $this->getSentDocumentXmlRequest($id, $inline, $contentType);
    ...
    /**
     * Create request for operation 'getSentDocumentXml'
     *
     * @param  string $id ID interno del documento (required)
     * @param  string|null $inline true para ver en el navegador, false para descargar (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSentDocumentXml'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSentDocumentXmlRequest($id, $inline = null, string $contentType = self::contentTypes['getSentDocumentXml'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getSentDocumentXml'
            );
        }



        $resourcePath = '/documents/sent/{id}/xml';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
