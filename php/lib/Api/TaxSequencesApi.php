...
class TaxSequencesApi
{
     ...
     */
    public function getNextNumber($type, $environment, string $contentType = self::contentTypes['getNextNumber'][0])
    {
        list($response) = $this->getNextNumberWithHttpInfo($type, $environment, $contentType);
        return $response;
    }
     ...
     */
    public function getNextNumberWithHttpInfo($type, $environment, string $contentType = self::contentTypes['getNextNumber'][0])
    {
        $request = $this->getNextNumberRequest($type, $environment, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getNextNumberAsync($type, $environment, string $contentType = self::contentTypes['getNextNumber'][0])
    {
        return $this->getNextNumberAsyncWithHttpInfo($type, $environment, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getNextNumberAsyncWithHttpInfo($type, $environment, string $contentType = self::contentTypes['getNextNumber'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getNextNumberRequest($type, $environment, string $contentType = self::contentTypes['getNextNumber'][0])
    {
     ...
     */
    public function listTaxSequences($type = null, string $contentType = self::contentTypes['listTaxSequences'][0])
    {
        list($response) = $this->listTaxSequencesWithHttpInfo($type, $contentType);
        return $response;
    }
     ...
     */
    public function listTaxSequencesWithHttpInfo($type = null, string $contentType = self::contentTypes['listTaxSequences'][0])
    {
        $request = $this->listTaxSequencesRequest($type, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listTaxSequencesAsync($type = null, string $contentType = self::contentTypes['listTaxSequences'][0])
    {
        return $this->listTaxSequencesAsyncWithHttpInfo($type, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listTaxSequencesAsyncWithHttpInfo($type = null, string $contentType = self::contentTypes['listTaxSequences'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listTaxSequencesRequest($type = null, string $contentType = self::contentTypes['listTaxSequences'][0])
    {
