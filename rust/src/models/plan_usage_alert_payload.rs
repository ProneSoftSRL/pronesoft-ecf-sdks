...
pub struct PlanUsageAlertPayload {
    /// Porcentaje de uso del plan.
    #[serde(rename = "usagePercent")]
    pub usage_percent: f64,
    /// Documentos restantes en el plan.
    #[serde(rename = "remainingDocs")]
    pub remaining_docs: i32,
}

impl PlanUsageAlertPayload {
    /// Payload del evento `plan.usage_alert`. El consumo de documentos superó el umbral configurado.
    pub fn new(usage_percent: f64, remaining_docs: i32) -> PlanUsageAlertPayload {
