...
pub struct EcfHistoryItem {
    ...
    #[serde(rename = "receivedAt", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
