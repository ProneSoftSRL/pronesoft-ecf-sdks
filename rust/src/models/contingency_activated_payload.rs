...
pub struct ContingencyActivatedPayload {
    #[serde(rename = "encf")]
    pub encf: String,
    ...
    #[serde(rename = "retryAt", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub retry_at: Option<Option<String>>,
}

impl ContingencyActivatedPayload {
    ...
    pub fn new(encf: String, reason: String) -> ContingencyActivatedPayload {
