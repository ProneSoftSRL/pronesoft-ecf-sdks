...
pub struct AssociatedCompanySubscription {
    ...
    pub plan: Option<Box<models::AssociatedCompanySubscriptionPlan>>,
}

impl AssociatedCompanySubscription {
    pub fn new() -> AssociatedCompanySubscription {
