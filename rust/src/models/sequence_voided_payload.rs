...
pub struct SequenceVoidedPayload {
    #[serde(rename = "sequenceType")]
    pub sequence_type: String,
    /// Rango de NCF anulados.
    #[serde(rename = "voidedRange")]
    pub voided_range: String,
    /// Motivo de la anulación.
    #[serde(rename = "reason")]
    pub reason: String,
}

impl SequenceVoidedPayload {
    /// Payload del evento `sequence.voided`. Se anuló un rango de secuencias.
    pub fn new(sequence_type: String, voided_range: String, reason: String) -> SequenceVoidedPayload {
