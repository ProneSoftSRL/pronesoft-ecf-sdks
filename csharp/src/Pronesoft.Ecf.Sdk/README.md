...
inputSpec: ./pronesoft-ecf/ecf-server/openapi.yaml
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{5A8AF144-D1D0-4596-A9FB-D37CA89E416A}'
...
## Api Information
- appName: eCF-Pronesoft Master Integration API
- appVersion: 0.0.1
- appDescription: **Highly detailed** production-grade API specification for eCF-Pronesoft. **Optimized for high-fidelity SDK generation.**  This specification is the result of an exhaustive audit of the source code (NestJS), covering 100% of the DTOs, regex validations, Webhook schemas, and  OAuth 2.0 security flows. 
