...
## Enum
    ...
    * `documentPeriodReceived` (value: `"document.received"`)

    * `documentPeriodStatus_changed` (value: `"document.status_changed"`)

    * `documentPeriodValidation_error` (value: `"document.validation_error"`)
    ...
    * `planPeriodPayment_failed` (value: `"plan.payment_failed"`)
