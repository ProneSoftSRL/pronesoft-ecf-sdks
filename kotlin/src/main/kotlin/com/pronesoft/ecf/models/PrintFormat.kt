...
enum class PrintFormat(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is PrintFormat) "$data" else null

        /**
         * Returns a valid [PrintFormat] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): PrintFormat? = data?.let {
